      ...
      <hr/>
         <table class="w3-table" style="width:950px;">
            <tr>
                ...
                <td class="auto-style1"><label> Chọn sinh viên: </label> </td>
                <td class="auto-style3">
                    <asp:DropDownList ID="dll_masv" runat="server" CssClass="w3-input w3-border" Width="346px" MaxLength="10" DataTextField="ten" DataValueField="masv" DataSourceID="SqlDataSource3"></asp:DropDownList>
