        ...
        <table>
            <tr>
                ...
                <td style="text-align:center;">
                    <asp:Label ID="lbl_mdk" runat="server" Text="Mã điều kiện"></asp:Label>
                </td>
                <td style="text-align:center;">
            ...
            <tr>
                ...
                <td><div style="float:left;">
                    <asp:TextBox ID="tbx_del" runat="server" CssClass="w3-input w3-small  w3-border" Width="100px" Height="36px" OnTextChanged="tbx_search_TextChanged" ></asp:TextBox>
                </div></td>
                <td><div style="float:left;">
