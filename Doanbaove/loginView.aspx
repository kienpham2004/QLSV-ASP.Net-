                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" runat="server" method="post">
                                            ...
                                            <div class="text-center">
                                                <a class="small" href="" id="create_user" style="text-decoration:none;">
                                                    <h3>Create an Account!</h3>
                                                </a>
                                            </div>
                                            <div id="popup_tao" style="margin-top: 10px; text-align: center;">
                                                <div class="form-group">
                                                    <asp:TextBox ID="tbx_creatuser" class="form-control form-control-user" runat="server" Text="Username"></asp:TextBox>
                                                </div>
                                                <div class="form-group">
                                                    <asp:TextBox ID="tbx_creatpass" class="form-control form-control-user" runat="server" Text="Password"></asp:TextBox>
                                                </div>
                                                <div class="form-group">
                                                    <asp:Label ID="lbl_tb1" runat="server" ForeColor="Red"></asp:Label>
                                                </div>
                                                <div class="form-group">
                                                    <asp:Button ID="btt_add" runat="server" class="btn btn-primary btn-user btn-block" Text="Create" OnClick="btt_add_Click" />
                                                </div>
                                            </div>
                                        </form>
                                    </div>
