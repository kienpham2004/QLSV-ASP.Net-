...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="test1">
        ...
        <asp:Label ID="lbl_tensv" runat="server" ForeColor="Red"></asp:Label>
            <br />
            <asp:Label ID="lbl_gt" runat="server" Text=""  ForeColor="Red"></asp:Label>
        <br />
        <asp:Label ID="lbl_masv" runat="server" Text=""  ForeColor="Red"></asp:Label>
        <br />
        <asp:Label ID="lbl_cn" runat="server" Text=""  ForeColor="Red"></asp:Label>
            <hr />
    </div>
