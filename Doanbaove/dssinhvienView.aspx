...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="w3-padding-4" >
        ...
        <div style="float:left;">
            <asp:Button ID="btt_search" runat="server" Text="Tìm kiếm" class="button" CssClass="w3-btn w3-blue" OnClick="btt_search_Click" Height="36px" Width="100px"/>
        </div>
        ...
        <div style="float:left; margin-left:50px">
            <asp:Button ID="btt_add" runat="server" Text="Thêm" class="button"  CssClass="w3-btn w3-blue" OnClick="btt_add_Click" Height="36px" Width="80px" PostBackUrl="~/sinhvienadd.aspx" />
        </div>
        <div style="float:left;">
            <asp:Button ID="btt_edit" runat="server" Text="Sửa" class="button"  CssClass="w3-btn w3-blue" OnClick="btt_edit_Click" Height="36px" Width="80px" PostBackUrl="~/sinhvienedit.aspx"/>
        </div>
        <div style="float:left;">
            <asp:Button ID="btt_del" runat="server" Text="Xóa" class="button"  CssClass="w3-btn w3-blue" OnClick="btt_del_Click" Height="36px" Width="80px"/>
        </div>
        <div style="float:left;">
