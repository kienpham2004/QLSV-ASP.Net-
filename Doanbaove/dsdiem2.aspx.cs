    ...
    public partial class dsdiem2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query1 = "Select tensv, masv, tencn from tbl_sinhvien inner join tbl_chuyennganh on chuyennganh = macn where masv=" + st_msv;
        ...
        protected void update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (check > 0)
                    {
                        Response.Redirect("~/dsdiem2.aspx?user=" + st_msv);
                    }
                    else
                    {
